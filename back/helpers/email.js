                                                            ...
                                                            <tbody>
                                                               ...
                                                               ${order.products.map(
                                                                 (p) => {
                                                                      ...
                                                                      <table style="border-collapse:collapse;">
                                                                         <tbody>
                                                                            <tr>
                                                                               ...
                                                                               <td style="border-collapse:collapse;color:#333333;font-family:Arial, Helvetica, sans-serif, Helvetica, Arial, sans-serif;font-size:13px;padding:5px;vertical-align:middle;text-align:left;"><span style="font-family:Helvetica, Arial, sans-serif;"><strong style="font-weight:600;"><a rel="nofollow noopener noreferrer" target="_blank" href="#/" style="outline:none;color:#bf3060;">${p.name}</a></strong></span>
                                                                               </td>
                                                                            </tr>
                                                                            <tr>
                                                                   ...
                                                                   <td style="border-collapse:collapse;color:#333333;font-family:Helvetica, Arial, sans-serif;font-size:13px;padding:10px 0px;border-bottom:1px solid #ebebeb;">
                                                                      <p style="margin:1em 0;text-align:center;font-family:Helvetica, Arial, sans-serif;"><strong style="font-weight:600;">${p.price}</strong></p>
                                                                   </td>
                                                                   <td style="border-collapse:collapse;color:#333333;font-family:Helvetica, Arial, sans-serif;font-size:13px;padding:10px 0px;border-bottom:1px solid #ebebeb;">
