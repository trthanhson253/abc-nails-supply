...
import SizeCreateModal from "../../../components/admin/SizeCreateModal";
...
const handleClose = () => {
  ...
  return (
   ...
   <AdminMenu />
   <div id="page-wrapper">
   <SizeCreateModal open={open} handleClose={handleClose} loadSizes={loadSizes} token={token}/>
   <div className="container-fluid">
       ...
       <Steps size="small" current={5}>
          ...
          <Step title="Size"  />
           ...
           <div className="col-lg-12">
               <h1 className="page-header">Size</h1>
           </div>
       ...
       <div className="col-lg-12">
           <div className="panel panel-default">
               ...
               <i className="fa fa-align-justify fa-fw" /> List of Size
               ...
               <div className="panel-body">
                   <div className="table-responsive">
                       <table className="table table-striped table-bordered table-hover" id="dataTables-example">
                           ...
                           <tbody>
                           {sizes.map((s) => (
                            <tr className="odd gradeX" key={s._id}>
                                <td>1</td>
                                <td>{s.name}</td>                                     
                                <td className="center">
