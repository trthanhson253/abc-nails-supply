   ...
   <>
    ...
    <div className="ut2-gl__item " style={{height: '418px'}}>
        ...
        <div className="ut2-gl__body" style={{height: '418px'}}><div className="ut2-gl__image" style={{height: '250px'}}>
            ...
            <img className="ty-pict lazyOwl cm-image abt-ut2-lazy-loaded" src={product.image[1].url} alt={product.name} title style={{opacity: 1}} />
            </Link>
            <div className="ut2-gl__buttons">
              ...
              <a className="ut2-add-to-wish cm-submit cm-tooltip" title="Add to wishlist" id="button_wishlist_7797">
                <i className="ut2-icon-baseline-favorite" />  </a>
              <a className="ut2-add-to-compare cm-ajax cm-ajax-full-render cm-tooltip" title="Add to comparison list" data-ca-target-id="comparison_list,account_info*,abt__ut2_compared_products" rel="nofollow" href="https://www.happynailsupply.com/index.php?dispatch=product_features.add_product&product_id=7797&redirect_url=index.php%3Fdispatch%3Dcategories.view%26category_id%3D15">
